        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm text-gray-400">
              ...
              <a href="https://github.com/Cyber-Rebel" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">GitHub</a>
            </div>
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className={`flex flex-wrap items-center justify-center gap-4 mb-20 transition-all duration-700 delay-200 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <a 
              href="#features"
              className="px-6 py-3 border border-white/20 rounded-full text-sm font-medium hover:bg-white/10 transition-all duration-200 flex items-center gap-2"
            >
              Learn more
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><a href="https://github.com/Cyber-Rebel" className="text-white hover:text-gray-300 transition-colors">GitHub</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><a href="https://github.com/Cyber-Rebel" className="text-white hover:text-gray-300 transition-colors">@Cyber-Rebel</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-white/5">
            ...
            <div className="flex items-center gap-4">
              <a href="https://github.com/Cyber-Rebel" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors">
